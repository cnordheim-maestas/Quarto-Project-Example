...
# note the qmd is within the report directory not the main directory! this is why we need to do the ../ aka "step back (think cd ..)
# OR you can mess with your execute directory in the quarto .yml (I did this)
# this is a quarto thing, rmd doesnt have this issue
